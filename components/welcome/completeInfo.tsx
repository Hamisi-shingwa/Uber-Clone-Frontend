...
setError("Please, give your firtname and lastname")
} else {
...
<TextInput placeholder="first name"  style={[Gstyle.border,Styles.textInput]}
    onChangeText={(val)=> {InputHandler("firstname",val)
    setError("")
}
    }/>
<TextInput placeholder="lastname"  style={[Gstyle.border,Styles.textInput]} onChangeText={
    (val)=> {InputHandler("lastname",val)
    setError("")
}
        }/>
</View>
